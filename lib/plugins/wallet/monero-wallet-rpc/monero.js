...
function newAddress (account, info) {
  // Get an integrated address. Payment id is random.
  return checkCryptoCode(cryptoCode)
  .then(() => fetch('make_integrated_address',[])
}

 function integrateBalance (payment_id){
  return checkCryptoCode(cryptoCode)
    .then(() => fetch('get_payments',[payment_id])
  }
